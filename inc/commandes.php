 ...
 */
function creer_commande_encours($id_auteur=false){
	...
	$id_auteur = intval($id_auteur) > 0 ? $id_auteur : (session_get('id_auteur') > 0 ? session_get('id_auteur') : 0);
	spip_log($id_auteur,'test.'._LOG_ERREUR);
	// La référence
